...
class Layout extends Component {
    constructor(props) {
        ...
        this.moduleStateKeys = ['slotA', 'slotB', 'slotC', 'slotD'];
        this.moduleSleepStateKeys = ['sleepSlotA', 'sleepSlotB', 'sleepSlotC', 'sleepSlotD'];
        this.moduleTapStateKeys = ['tapSlotA', 'tapSlotB', 'tapSlotC', 'tapSlotD'];
        ...
        if (shouldShow(this.currentVersion, '3.7', null)) {
            this.modulesAll = this.modulesAll.concat([{ value: '13', label: this._('Active time') }]);
                        ...
                        <div>
                            ...
                            <Versioned maxVersion="3.8" version={this.currentVersion}>
                                <ColorPicker
                                    ...
                                    label={this._('Alternate time color')}
